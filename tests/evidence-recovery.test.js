...
(async()=>{
  ...
  assert.ok(sw.includes("gravi-sst-v2-shell-v42"));assert.equal((sw.match(/print-documents\.css\?v=34/g)||[]).length,0);
  console.log("Recuperacion remota, precedencia local, mutex, orden de sincronizacion, correccion, RLS, Storage y PWA V42 verificados.");
