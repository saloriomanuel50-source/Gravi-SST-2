...
for (const reference of ["./src/app.js", "./src/corporate-documents.js", "./src/extensions.js?v=2", "./src/system.js", "./src/pwa.js"]) {
  if (!bootstrap.includes(reference)) fail(`bootstrap.js no carga ${reference}`);
}

const serviceWorker = read("service-worker.js");
for (const reference of ["./src/app.js", "./src/supabase.js", "./src/bootstrap.js", "./src/styles/phase5-2.css?v=13", "./assets/gravi-sst-logo-dark.png", "./assets/gravi-sst-login-panel.png", "./assets/gravi-sst-splash.png", "./assets/pwa-icon-192.png"]) {
