...
for (const reference of ["./src/app.js", "./src/supabase.js", "./src/bootstrap.js", "./src/styles/phase5-2.css?v=10", "./assets/gravi-sst-logo-dark.png", "./assets/gravi-sst-login-panel.png", "./assets/gravi-sst-splash.png", "./assets/pwa-icon-192.png"]) {
